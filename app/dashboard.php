...
?>      
  ...
  <h1 class="display-5">Sampaikan</h1>
  <p class="lead">Keluhan anda pada kami.</p>
  <div class="jumbotron-search">
    <form action="search.php" method="POST">
      <p class="lead" style="margin-bottom: -1px;">Untuk cek status pengaduan Anda</p>
    ...
    <p class="lead mt-2">Untuk Pengajuan anda bisa klick</p>
